...
import { CompanyBalanceSheet, CompanyCashFlow, CompanyCompareData, CompanyIncomeStatement, CompanyKeyMetrics, CompanyProfile, CompanySearch, CompanyTenK } from "./company";
...
export const getCompareData = async (query: string) => {
  try {
    const data = await axios.get<CompanyCompareData[]>(
